def uaac():
	...
	def test():
		try:
			runuacpy = r'C:\ransomtesting\internals'+os.sep+'ransomtestingreal.exe'
...
try:
	os.system(r'mkdir "C:\ransomtesting\internals"')
except:
	pass
...
try:
	...
	rded=rded.strip()
	vgb=open(r'C:\ransomtesting\internals'+os.sep+'conne.exe',"w") # record the ip address
	vgb.write(rded)
	vgb.close()
except:
	pass 
...
############### extract ransomtestingreal in internals folder... startautorunsc.exe ,autorunsc.exe, procmon,sysmon,handle64 in same folder too..
import pefile
...
listofresource=[r'C:\ransomtesting\internals'+os.sep+'ransomtestingreal.exe',\
r'C:\ransomtesting\internals'+os.sep+'startautorunsc.exe',\
...
r'C:\ransomtesting\internals'+os.sep+'procdelete.exe',r'C:\ransomtesting\internals'+os.sep+'procstop.exe',\
r'C:\ransomtesting\internals'+os.sep+'MBRFilter.inf',r'C:\ransomtesting\internals'+os.sep+'MBRFilter.sys',\
r'C:\ransomtesting\internals'+os.sep+'procprocess.exe',r'C:\ransomtesting\internals'+os.sep+'autoprocess.exe',\
r'C:\ransomtesting\internals'+os.sep+'Roadblock_desktop.exe',r'C:\ransomtesting\internals'+os.sep+'Roadblock_conn.exe',\
r'C:\ransomtesting\internals'+os.sep+'roadblock_starter.exe',r'C:\ransomtesting\internals'+os.sep+'PsExec64.exe',\
r'C:\ransomtesting\internals'+os.sep+'image.exe',r'C:\ransomtesting\internals'+os.sep+'sigcheck64.exe']
