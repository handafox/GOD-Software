...
def deletealloldfiles():
	...
	try:
		...
		r'C:\ransomtesting\internals'+os.sep+'ransomtestingreal2.exe',\
		r'C:\ransomtesting\internals'+os.sep+'procdelete.exe',r'C:\ransomtesting\internals'+os.sep+'procserv.exe',r'C:\ransomtesting\internals'+os.sep+'procstop.exe',\
		r'C:\ransomtesting\internals'+os.sep+'procprocess.exe',r'C:\ransomtesting\internals'+os.sep+'autoprocess.exe',\
		r'C:\ransomtesting\internals'+os.sep+'firstnet.exe',r'C:\ransomtesting\internals'+os.sep+'conne.exe',\
		r"C:\ransomtesting\internals"+os.sep+'firstnetdone.exe']
		for i in a:
			print i
			time.sleep(5)
			if os.path.isdir(i)==False:
				...
				if deletei==0:
					...
					time.sleep(5)
					pass
		dsdd=open(r"C:\ransomtesting\internals"+os.sep+'donedeletion.exe',"w")
		dsdd.write()
		dsdd.close()
	except Exception as ex:
		print ex
...
def copyransomcheck():
	haikya=os.path.exists(r'C:\ransomtesting\internals'+os.sep+'ransomtestingcheck.exe')
	## not needed as of now, will tell check software is in this folder
	"""
	if haikya==False:
		try:
			from shutil import copyfile
			copyfile(r'C:\ransomtesting\internals'+os.sep+'ransomtestingcheck.exe',r"C:\ransomtesting"+os.sep+'ransomtestingcheck.exe')
		except:
			pass
	"""
	pass
...
def gethashes():
	...
	#### getting the hashes.....
	try:
		filewa=r"C:\ransomtesting\hashvalue"+os.sep+'hashlist.exe'
		f=open(filewa,"r")
		icount=0
		"""
		while True:
...
def monitorfile(username):
	...
	try:
		...
		def startprocmon():
			global countofdeinfection
			if countofdeinfection>1:
				print 'startprocmon not needed now..'
				return 1
			try:
			...
			while True:
				if iaminwhat==1 and gofordeinfection==1:
					...
					try:
						...
						fcd=open(r'C:\ransomtesting\internals'+os.sep+'infdtc.exe','a+')
			...
			try:
				while True:
					if gofordeinfection==2:
						fg=open(r"C:\ransomtesting\internals"+os.sep+'hey0.exe',"w")
						fg.close()
						time.sleep(10)# waiting for roadblock_desktop to return its output
						if os.path.exists(r"C:\ransomtesting\internals"+os.sep+'hey2.exe')==True:# user know what its doing
							checkfirsttime()
						else:
							gofordeinfection=1
						break
				...
				if threadName=="Thread-1":
					try:
						...
						if monfile1!=hashfile1:
							#print 'under if'
							try:
								f=open(r'C:\ransomtesting\internals'+os.sep+'Abruptransomtesting.exe',"w")
								...
								fp=open(r'C:\ransomtesting\internals'+os.sep+'timeransomtesting.exe','w')
								fp.write(str(now)+'\n')
		...
		#thread7 = myThread(7, "Thread-7", 7)## only for starting procmon
...
def daemon():
	try:
		print 'Going to execute procmon..11111111111111111..'
		time.sleep(5)
		#os.system(r'C:\ransomtesting\internals\procmon.exe /AcceptEula /Quiet /Minimized /BackingFile test')
		print 'executed procmon....11111111111111111111111111111...'
		#sys.exit(0)
		pass
	except Exception as ex:
		print ex
...
if __name__ == '__main__':
	...
	while True:
		...
		try:
			deletealloldfiles()
			if os.path.exists(r"C:\ransomtesting\internals"+os.sep+'donedeletion.exe')==True:
				print 'deletion done..'
				time.sleep(5)
				break
			else:
	...
	#TODO: doing now
	"""
	# start procmon using multiprocessing
	print 'Going to execute procmon....'
	print 'Going to execute procmon....'
	print 'Going to execute procmon....'
	print 'Going to execute procmon....'
	print 'Going to execute procmon....'
	...
	def userconsent(): # getuserconsent
			"""
			if os.path.exists(r"C:\ransomtesting\internals"+os.sep+'alreadyconsent.exe')==True:
				return 1
			else:
				fg=open(r"C:\ransomtesting\internals"+os.sep+'alreadyconsent.exe',"w")
				fg.close()
			"""
			...
			try:
				while True:
					if gofordeinfection==2 and (not os.path.exists(r"C:\ransomtesting\internals\gome.exe")):
						try:
							jn=open(r"C:\ransomtesting\internals\gome.exe",'w')
							jn.close()
						except:
							pass
						try:
						...
						if os.path.exists(r"C:\ransomtesting\internals"+os.sep+'hey2.exe')==True:# user know what its doing
							...
							delkaro=r"C:\ransomtesting\internals\gome.exe"
							...
							os.system('del /F /Q /A '+r"C:\ransomtesting\internals"+os.sep+'hey2.exe')
							gofordeinfection=0
							checkfirsttime()
	...
	fcgh=open(r"C:\ransomtesting\internals"+os.sep+'firstnet.exe',"w")
	fcgh.close()
